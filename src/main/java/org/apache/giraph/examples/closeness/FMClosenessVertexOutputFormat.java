 ...
 */
public class FMClosenessVertexOutputFormat extends
    TextVertexOutputFormat<IntWritable, FMVertexStateWritable, NullWritable> {

  @Override
  public VertexWriter<IntWritable, FMVertexStateWritable, NullWritable> createVertexWriter(
      TaskAttemptContext context) throws IOException, InterruptedException {
    RecordWriter<Text, Text> recordWriter = textOutputFormat
        .getRecordWriter(context);
    return new FMClosenessVertexOutputFormat.ClosenessVertexWriter(recordWriter);
  }
  ...
  public static class ClosenessVertexWriter extends
      TextVertexWriter<IntWritable, FMVertexStateWritable, NullWritable> {
    /**
    ...
    public void writeVertex(
        BasicVertex<IntWritable, FMVertexStateWritable, NullWritable, ?> vertex)
